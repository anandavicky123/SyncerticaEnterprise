...
import { createTaskUpdateNotification, createWorkerMessageNotification, getManagerNotifications } from '../lib/notifications';
...
async function testNotifications() {
  ...
  try {
    ...
    notifications.forEach((notif, index) => {
      console.log(`  ${index + 1}. Type: ${notif.type}, Status: ${notif.status}`);
