...
- **Real-time Analytics** - DynamoDB-powered event tracking
...
```env
# Database
DATABASE_URL="postgresql://username:password@localhost:5432/syncertica_db"
...
# Analytics
DYNAMODB_TABLE_NAME="syncertica-sessions"
LAMBDA_FUNCTION_NAME="syncertica-data-processor"
```
