    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            Welcome to your manager dashboard. Here's an overview of your team and projects.
          </p>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <a
            href="/dashboard/manager/workers"
          ...
          >
            ...
            <div className="mt-8">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Create accounts for new team members and assign them to projects.
              </p>
            </div>
          </a>
          ...
          <div className="p-6">
            <div className="text-center text-gray-500">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Get started by adding workers and creating projects.
              </p>
            </div>
          </div>
        </div>
